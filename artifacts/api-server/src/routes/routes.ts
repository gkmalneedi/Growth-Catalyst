...
import fs from "fs";
import { storage, seedDefaultContent } from "../storage";
import {
...
// Seed default content on startup (only inserts missing keys)
seedDefaultContent().catch(err => console.error("Seed error:", err));

// ── Admin: Image Upload ───────────────────────────────────────────────────
appRouter.post("/admin/upload", adminAuth, upload.single("image"), (req: any, res) => {
  if (!req.file) return res.status(400).json({ message: "No file uploaded" });
  res.json({ url: `/uploads/${req.file.filename}` });
});

// ── Admin login check ────────────────────────────────────────────────────
appRouter.post("/admin/login", (req, res) => {
...
// ── Admin: Blogs CRUD ────────────────────────────────────────────────────
appRouter.post("/admin/blogs", adminAuth, async (req, res) => {
...
appRouter.put("/admin/blogs/:id", adminAuth, async (req, res) => {
...
appRouter.delete("/admin/blogs/:id", adminAuth, async (req, res) => {
...
appRouter.post("/admin/case-studies", adminAuth, async (req, res) => {
...
appRouter.put("/admin/case-studies/:id", adminAuth, async (req, res) => {
...
appRouter.delete("/admin/case-studies/:id", adminAuth, async (req, res) => {
...
appRouter.post("/admin/press-releases", adminAuth, async (req, res) => {
...
appRouter.put("/admin/press-releases/:id", adminAuth, async (req, res) => {
...
appRouter.delete("/admin/press-releases/:id", adminAuth, async (req, res) => {
...
appRouter.delete("/admin/services/:id", adminAuth, async (req, res) => {
...
appRouter.delete("/admin/industries/:id", adminAuth, async (req, res) => {
...
appRouter.post("/admin/portfolio", adminAuth, async (req, res) => {
...
appRouter.put("/admin/portfolio/:id", adminAuth, async (req, res) => {
...
appRouter.delete("/admin/portfolio/:id", adminAuth, async (req, res) => {
...
// ── Site Settings ─────────────────────────────────────────────────────────
appRouter.get("/site-settings", async (_req, res) => {
  try {
...
appRouter.put("/admin/site-settings/:key", adminAuth, async (req, res) => {
  try {
...
appRouter.get("/admin/submissions", adminAuth, async (_req, res) => {
...
appRouter.post("/newsletter", async (req, res) => {
  try {
