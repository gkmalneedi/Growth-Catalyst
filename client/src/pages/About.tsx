          ...
          <div className="flex animate-marquee whitespace-nowrap gap-20 items-center">
            {clientsList.map((client, i) => (
              typeof client === "object" && client.imageUrl
                ? <span key={i} className="inline-flex items-center justify-center mx-6"><img src={client.imageUrl} alt={client.name} className="h-12 max-w-36 object-contain" /></span>
            ...
            {clientsList.map((client, i) => (
              typeof client === "object" && client.imageUrl
                ? <span key={`dup-${i}`} className="inline-flex items-center justify-center mx-6"><img src={client.imageUrl} alt={client.name} className="h-12 max-w-36 object-contain" /></span>
