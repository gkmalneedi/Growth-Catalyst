...
interface Redefined { title: string; desc: string; }
interface Service {
  title: string;
  href: string;
  description: string;
...
export default function ServiceTemplate() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* ── 2. STATS + REDEFINED (split section, Miraki-style) ── */}
        ...
        <div className="container mx-auto px-4 md:px-8 flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="lg:w-2/3">
            <Accordion type="single" collapsible className="w-full">
              {[
                {
                  q: `How can ${service.title} help our business grow?`,
                  a: `Our strategic approach to ${service.title} ensures that every action is aligned with your business goals, driving measurable growth, increased efficiency, and higher ROI through data-driven execution.`
                },
                {
                  q: `What makes your ${service.title} services unique?`,
                  a: `We blend creative storytelling with AI-powered analytics. We don't just execute tasks; we engineer strategies that adapt to market trends and user behavior in real-time.`
                },
                {
                  q: `How do you measure success in ${service.title}?`,
                  a: `We use a comprehensive suite of KPIs tailored to your specific objectives, ranging from engagement metrics and conversion rates to long-term customer lifetime value and brand sentiment analysis.`
                },
                {
                  q: `How long before we see results?`,
                  a: `Results vary by service and industry, but most clients see measurable impact within 30–60 days. We set clear milestones and share transparent reporting throughout the engagement.`
                }
              ].map((faq, i) => (
